...
while not done:
            ...
            #Prevents user from selecting input while holding down mouse button
                if pygame.mouse.get_pressed() == (1,0,0):
                    ...
                    #Choice1 Button Pressed
                        randomQuestion,allChoices,questionsList=evaluateAnswer(1,questionsList,randomQuestion,allChoices)
                        stage+=1
                        timeLeft-=1
                    ...
                    #Choice2 Button Pressed
                        randomQuestion,allChoices,questionsList=evaluateAnswer(2,questionsList,randomQuestion,allChoices)
                        stage+=1
                        timeLeft-=1
                        questionEnd=time.time()
                        projectileTimerStart=time.strftime("%S")
                    ...
                    #Choice3 Button Pressed
                        randomQuestion,allChoices,questionsList=evaluateAnswer(3,questionsList,randomQuestion,allChoices)
                        stage+=1
                        timeLeft-=1
                        questionEnd=time.time()
                        projectileTimerStart=time.strftime("%S")
                    ...
                    #Choice4 Button Pressed
                        randomQuestion,allChoices,questionsList=evaluateAnswer(4,questionsList,randomQuestion,allChoices)
                        stage+=1
                        timeLeft-=1
                        questionEnd=time.time()
                        projectileTimerStart=time.strftime("%S")
    ...
    if currentScreen=="questionScreen":
        if randomQuestion=="Blank":
            ...
            allChoices=[]
            randomQuestion=questionsList.keys()[random.randint(0,(len(questionsList)-1))]
            str(randomQuestion)
            ...
            for number in randomOrder:
                allChoices.append(blitChoice(questionsList[randomQuestion][number],200+(randomOrder.index(number)*73)))
